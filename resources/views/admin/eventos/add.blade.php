        ...
        <div class="card-body">
            <form method="POST" role="form" enctype="multipart/form-data">                
                ...
                <div class="form-group row">            
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nome" value="{{old('nome')}}" placeholder="Digite o Nome do evento" class="form-control @error('nome') is-invalid @enderror" />
                    </div>            
                </div>  
                <div class="form-group row">            
                    <label class="col-sm-2 col-form-label">Data</label>
                    <div class="col-sm-3">
                        <input type="date" name="data" value="{{old('data')}}"  class="form-control @error('data') is-invalid @enderror" />
                    </div>            
                </div>    
                <div class="form-group row">            
                    <label class="col-sm-2 col-form-label">Local</label>
                    <div class="col-sm-5">
                        <input type="text" name="local" value="{{old('local')}}"  class="form-control @error('local') is-invalid @enderror" />
                    </div>            
                </div>                 
                ...
                <div class="form-group row">            
                    ...
                    <div class="col-sm-10">
                        <textarea name="descricao" class="form-control bodyfield">{{old('descricao')}}</textarea>                            
                    </div>            
                </div> 
